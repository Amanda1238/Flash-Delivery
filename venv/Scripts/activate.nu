...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\amanda\PycharmProjects\ProjetoFlashDelivery\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\amanda\PycharmProjects\ProjetoFlashDelivery\venv\Scripts\deactivate.nu'
